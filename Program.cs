...
{
    Console.WriteLine("ApplicationDataHelper.CurrentApplicationData is not null");
    Console.WriteLine($"ApplicationDataHelper.LocalFolderPath: {ApplicationDataHelper.LocalFolderPath}");
    Console.WriteLine($"ApplicationDataHelper.TemporaryFolderPath: {ApplicationDataHelper.TemporaryFolderPath}");
}
